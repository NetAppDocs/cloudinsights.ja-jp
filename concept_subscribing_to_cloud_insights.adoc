...
ワークロードのセキュリティは、使用されているノードがハイエンド、ミッドレンジ、エントリレベルのいずれであるかに応じて、次のManaged Unit（MU）数で計測されます。
...
| ハイエンドノード×1 | 700、800、900、9xxx | 80マネージドユニット 


| 1つのミッドレンジノード | 300、400、500、8x00 | 40マネージドユニット 


| エントリレベルノード×1 | 1xx、2xx、2xxx | 管理対象ユニット×20 


| ソフトウェアONTAP×1 | CVO、FSx | 管理対象ユニット×10 
