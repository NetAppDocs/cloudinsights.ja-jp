...
Cloud Insightsベーシックエディションとプレミアムエディションで利用可能な機能の完全な比較については、link:https://www.netapp.com/cloud-services/cloud-insights/editions-pricing["Cloud Insightsの価格設定"]ページを参照してください。
