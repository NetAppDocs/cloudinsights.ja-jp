...
|  | skipLockedMemory | を参照してください link:https://community.influxdata.com/t/updating-telegraf-to-version-1-29-5-crashes-kubernetes-pod/33376["既知のTelegraf問題"]。  skipLockedMemoryを設定すると、Kubernetes Monitoring OperatorにTelegrafを `--unprotected` フラグ。 
