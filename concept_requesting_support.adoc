...
NOTE: に登録する必要があります  support entitlement and accessing support,サポートを有効にします ネットアップのクラウド製品の場合：登録は、ネットアップのにアクセスしてください link:https://register.netapp.com["クラウドデータサービスサポート登録"]。
