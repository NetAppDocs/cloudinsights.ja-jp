...
[role="lead"]
Cloud Insights では、 Brocade Enterprise Fabric Connectivity Manager （ EFCM ）データコレクタを使用して、 Brocade EFCM スイッチのインベントリを検出します。Cloud InsightsはEFCMバージョン9.5、9.6、および9.7をサポートしています。
