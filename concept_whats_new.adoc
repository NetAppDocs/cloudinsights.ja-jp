...
=== Kubernetes PVデータをレポートします

Cloud Insights で収集されたKubernetes永続ボリューム（PV）情報をレポート作成で使用できるようになり、チャージバック、トレンド分析、予測、TTF計算、 また、Kubernetesクラスタ、ネームスペース、ワークロードなどの指標に関するその他のビジネスレポートも作成できます。
...
* https://[] （注：ネットアップサポートにサインインする必要があります）。
* https://[]
