...
* OpenShift 4.6-4.8 で実行している場合は、以下の * OpenShift Instructions * を参照する必要があります。
...
* NetApp Kubernetes Monitoring Operator インストールはテスト済みで、 AWS EKS 1.18-1.21 、 OpenShift 4.6-4.8 、 Rancher 2.4-2.6 で動作することが予想されています。
